...
- [src/publisher.langium](src/publisher.langium) -  The grammar definition of your language
- [src/publisher-module.ts](src/publisher-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/publisher-validator.ts](src/publisher-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/publisher.monarch.ts](src/syntaxes/publisher.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/publisher.tmLanguage.json](syntaxes/publisher.tmLanguage.json) - Textmate based syntax highlighting instructions.
